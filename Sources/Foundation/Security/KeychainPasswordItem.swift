...
extension KeychainPasswordItem {
   ...
   public func savePassword(_ password: String, accessibility: SecAttribute.Accessible) throws {
      ...
      do {
         ...
         let existingPassword = try readPassword()
         if existingPassword != nil {
            // Update the existing item with the new password.
            var attributesToUpdate: [String: AnyObject] = [:]
            attributesToUpdate[kSecValueData as String] = encodedPassword as AnyObject
            attributesToUpdate.update(pair: accessibility.pair)
            ...
            newItem.update(pair: accessibility.pair)
